...
**Анализ проверки работ экспертами**
...
- **Основные библиотеки:** pandas, datetime, openpyxl
...
1. Запуск:
    Запустите редактор  gui:
    utils/run_editor.bat
```
# Запустите редактор  терминале:
